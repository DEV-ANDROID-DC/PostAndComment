...
import com.debin.pac.BuildConfig;
import com.debin.pac.PACApplication;
...
public class RetrofitInstance {
    ...
    private static Cache cache() {
        return new Cache(new File(PACApplication.getInstance().getCacheDir(), "someIdentifier"), cacheSize);
    }
